...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, 5, 3, WA_CENTER }, 140, false, MAX_WIDTH, 5000, 4, 40 };
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 41, 3, WA_LEFT }, 140, false, MAX_WIDTH, 5000, 4, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 184, 3, WA_LEFT }, 300, false, MAX_WIDTH, 0, 3, 40 };	// Weather (погода)

/* BACKGROUNDS  */                       /* {{ left, top, fontsize, align }, width, height, outlined } */
const FillConfig   metaBGConf     PROGMEM = {{ 0, 32, 0, WA_LEFT }, DSP_WIDTH, 2, false };
const FillConfig   metaBGConfInv  PROGMEM = {{ 0, 32, 0, WA_LEFT }, MAX_WIDTH, 2, false };
...
const WidgetConfig voltxtConf     PROGMEM = { TFT_FRAMEWDT, 216, 2, WA_LEFT };
const WidgetConfig  iptxtConf     PROGMEM = { TFT_FRAMEWDT, 216, 2, WA_CENTER };
const WidgetConfig   rssiConf     PROGMEM = { TFT_FRAMEWDT, 216, 2, WA_RIGHT };
...
const WidgetConfig  clockConf     PROGMEM = { 22, 152, 52, WA_RIGHT };  /* 52 is a fixed font size. do not change */
const WidgetConfig vuConf         PROGMEM = { 0, 188, 1, WA_CENTER };
const WidgetConfig bootWdtConf    PROGMEM = { TFT_FRAMEWDT, 162, 2, WA_CENTER };

const ProgressConfig bootPrgConf  PROGMEM = { 100, 14, 4 };
const BitrateConfig fullbitrateConf PROGMEM = {{TFT_FRAMEWDT+8, 108, 2, WA_RIGHT}, 42 };

/* BANDS  */                             /* { onebandwidth, onebandheight, bandsHspace, bandsVspace, numofbands, fadespeed } */
//const VUBandsConfig bandsConf   	PROGMEM = { 150, 20, 8, 1, 10, 3 };
const VUBandsConfig bandsConf     PROGMEM = { 312/2, 20, 6, 1, 16, 3 };	//Boombox
...
const MoveConfig    clockMove     PROGMEM = { 22, 152, 0 };
const MoveConfig   weatherMove    PROGMEM = { 0, 184, 0 };
const MoveConfig   weatherMoveVU  PROGMEM = { 0, 160, 0 };
