...
#define LFS_MAXLENGTH_FILEPATH 32 // Вместо SPIFFS_MAXLENGTH_FILEPATH
...
//  static char linebuf[SPIFFS_MAXLENGTH_FILEPATH];
    static char linebuf[LFS_MAXLENGTH_FILEPATH]; // Используем новое имя
    ...
    if (excludeFile.size() > 0){
      ...
      while (excludeFile.available()){
        ...
        // Заменяем старую константу на новую:
