...
#define YOVERSION "0.9.535(m)-3.4.2p"
#define I2SVER "3.4.2p"
/*******************************************************
...
#define DSP_ST7789_170  26    // 320x170  1.9'  https://aliexpress.ru/item/1005006158153608.html
...
#endif
#ifndef DSP_SSPI
  #define DSP_SSPI   false      // for ESP32-S3: use SubSPI for displays (miso=37, mosi=35, clk=36) instead of FSPI (by default: miso=13, mosi=11, clk=12)
#endif
#ifndef LED_INVERT
...
#define HOOPSENb 2
  ...
  #define SCREENSAVERSTARTUPDELAY 20
#endif
