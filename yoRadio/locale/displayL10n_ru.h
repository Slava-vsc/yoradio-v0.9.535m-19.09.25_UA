...
const char ocb[] PROGMEM = "жовтня";
const char nov[] PROGMEM = "листопада";
const char dcb[] PROGMEM = "грудня";

const char wn_N[]      PROGMEM = "ПІВ";
...
const char  const_PlConnect[]    PROGMEM = "[зєднання]";
...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, темп.: %+.1f\011C (Відчувається: %+.0f\011C) \007 Тиск: %d мм \007 Вологiсть: %s%% \007 вiтер %s %.0f%s м/с (м.ст. %s)";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 тиск: %d mm \007 вологiсть: %s%%";
#endif
